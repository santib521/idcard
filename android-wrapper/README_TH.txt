...
3. มีปุ่ม "อ่านบัตร" ลอยมุมขวาล่าง
4. Login และเปลี่ยนหน้า HIS แล้วปุ่มยังอยู่
5. กดอ่านบัตรแล้วเปิดหน้าต่าง MKT SmartCard เต็มพื้นที่
6. กด × หรือ Back เพื่อกลับ HIS; Session และหน้าปัจจุบันของ HIS ต้องยังอยู่
